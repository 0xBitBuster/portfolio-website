        ...
        <nav className="flex items-center justify-between px-10 my-6 mx-auto max-w-[1248px]">
            ...
            <div>
                <div className="hidden md:flex space-x-7 text-lg font-semibold underline-offset-8">
                    ...
                    <a className="cursor-pointer hover:underline" href="#whatido">What I Do</a>
                    <a className="cursor-pointer hover:underline" href="#projects">My Work</a>
                ...
                <div className={`z-10 fixed top-0 h-screen w-screen bg-white flex flex-col items-center justify-center space-y-10 text-2xl font-semibold underline-offset-8 ${isToggled ? "left-0" : "left-full"} duration-500`}>
                    <a className="cursor-pointer hover:underline" href="#aboutme" onClick={() => setIsToggled(!isToggled)}>About</a>
                    <a className="cursor-pointer hover:underline" href="#whatido" onClick={() => setIsToggled(!isToggled)}>What I Do</a>
                    <a className="cursor-pointer hover:underline" href="#projects" onClick={() => setIsToggled(!isToggled)}>My Work</a>
