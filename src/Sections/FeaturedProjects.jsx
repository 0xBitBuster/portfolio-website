            ...
            <div className="flex flex-col sm:flex-row w-screen">
                ...
                <div className="flex flex-col justify-center sm:w-1/2 bg-white p-8 sm:p-12">
                    ...
                    <motion.p 
                        ...
                        transition={{ duration: 0.3, delay: 0.3, ease: "backOut" }}
                    >
                        Convert your speech into text so you can have a real conversation with (a talking) ChatGPT. This extension is ideal for anyone who needs to quickly convert spoken words into written text.
                    </motion.p>
                    <motion.a 
