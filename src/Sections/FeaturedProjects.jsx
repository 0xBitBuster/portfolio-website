                ...
                <div className="flex flex-col justify-center sm:w-1/2 bg-white p-8 sm:p-12">
                    <div className="max-w-5xl mr-auto">
                        ...
                        <motion.p 
                            ...
                            transition={{ duration: 0.3, delay: 0.3, ease: "backOut" }}
                        >
                            Convert your speech into text so you can have a real conversation with (a talking) ChatGPT. <br /> This extension is ideal for anyone who needs to quickly convert spoken words into written text.
                        </motion.p>
                        <motion.a 
                ...
                <div className="flex flex-col justify-center sm:w-1/2 bg-white p-8 sm:p-12">
                    <div className="max-w-5xl ml-auto">
                        ...
                        <motion.p 
                            ...
                            transition={{ duration: 0.3, delay: 0.3, ease: "backOut" }}
                        >
                            Sycheats was a former platform for sharing and downloading cheats for video games. All cheats were tested for malware, authentication was handled using JWTs (Access + Refresh Tokens) and Redis.
                        </motion.p>
                        <motion.p 
